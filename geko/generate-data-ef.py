...
#
out_file_name = '/media/sf_Mestrado/workspace/python/dptee4RL/data/data-10000-2000-r5.csv'
...
# itself.
#
attr_name_list = ['gender', 'given-name', 'surname',
                  'birth', 'income-normal',
                   'income', 'sex']
...
attr_mod_data_dictionary = {'gender':[(1.0, missing_val_corruptor)],
                            ...
                            'given-name':[(0.1, edit_corruptor2),
                                          ...
                                          (0.3, missing_val_corruptor),
                                          (0.4, phonetic_corruptor)],
                            'income':[(0.1, missing_val_corruptor),
                                      (0.9,edit_corruptor2)],
                            'birth':[(1.0, ocr_corruptor_date)]}
