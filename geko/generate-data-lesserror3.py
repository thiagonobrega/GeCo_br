...
#
out_file_name = 'data/data-numeric-500-100SDDN.csv'
...
# itself.
#
attr_name_list = [ 'given-name','birth', 'death',
                   'income-normal']


attr_data_list = [ gname_attr,income_normal_attr, birth_date_uniform_attr , 
                  death_date_uniform_attr]
...
#
attr_mod_data_dictionary = {'death':[(0.1, ocr_corruptor_date),
                                     (0.9, my_date_corruptor)],
