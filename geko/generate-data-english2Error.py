...
date_corruptor = corruptor.CorruptValueOCR(\
          position_function = corruptor.position_mod_normal,
          lookup_file_name = 'lookup-files/ocr-variations-numbers.csv',
          has_header_line = False,
          unicode_encoding = unicode_encoding_used)
...
#
attr_mod_prob_dictionary = {'gender':0.1, 'given-name':0.1,'surname':0.1,
                            'city':0.1, 'telephone-number':0.1,
                            'birth':0.5}
