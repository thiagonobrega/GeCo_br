...
#
out_file_name = 'data/data-numeric-2000-400.csv'
...
# itself.
#
attr_name_list = [ 'birth', 'death',
                   'income-normal']


attr_data_list = [ income_normal_attr, birth_date_uniform_attr , 
                  death_date_uniform_attr]
...
#
attr_mod_prob_dictionary = {'death':0.25,
                            'income-normal':0.45,
                            'birth':0.30}
